...
- **Rafael N. Magalhães**. Author, maintainer.
...
Brazilian Electoral Polls*. R package version 1.0.2,
<https://rnmag.github.io/agregR/>.

    @Manual{,
      title = {agregR: Bayesian State-Space Aggregation of Brazilian Electoral Polls},
