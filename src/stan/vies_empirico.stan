...
//
// Neste modelo, essa âncora é o viés observado empiricamente para cada insti-
// tuto de pesquisa na eleição anterior. Ele é o ponto fixo em torno do qual
// são solucionados os parâmetros, e é incorporado como um vetor de prioris pa-
// ra o parâmetro delta. O viés é calculado por turno e por perfil ideológico
...
transformed parameters {
  ...
  delta = emp_delta_priori + delta_raw * sd_delta_priori;
